...
minimap_vars_iter = minimap_vars_iter %>% filter(iteration==1)
...
div_called_p = ggplot(minimap_vars_iter, aes(x=divergence, y=perc.called.sites, color=iteration)) +
  ...
  geom_line(data=sim_vars_div_iter1, aes(x=divergence, y=perc.var.sites), color="#920000") +
  geom_point(data=sim_vars_div_iter1, aes(x=divergence, y=perc.var.sites), size=4, color="#920000") +
...
```{r save-dots, include=FALSE}
  outfilename = here("evolution", "figs", "06-iterative-divergence-1.png")
